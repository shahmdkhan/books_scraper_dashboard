...
class Detail(models.Model):
    # --------Interest flag---------
    PENDING        = "pending"      #todo: Neutral/Normal Book
    INTERESTED     = "interested"
    NOT_INTERESTED = "not_interested"

    INTEREST_CHOICES = [(PENDING, "Pending"), (INTERESTED,     "Interested"), (NOT_INTERESTED, "Not Interested"),]

    detail_id   = models.AutoField(primary_key=True)
    history     = models.ForeignKey(History, on_delete=models.CASCADE, db_column="history_id", related_name="details",)
    isbn         = models.CharField(max_length=255)
    date_scraped = models.DateField(auto_now_add=True)      #TODO: updated scraped at
    first_seen   = models.DateField(auto_now_add=True)      #TODO: first Scraped at
